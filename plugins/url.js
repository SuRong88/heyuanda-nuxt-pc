...
const api = {
  getArticleType:'/article/classify', // 文章分类
  getArticleList: '/article/lists', // 文章列表
  getArticleDetail: '/article/info', // 文章详情
  getWebInfo: '/setting/info', // 网站信息
  getNavList:'/nav', // 2.新网站导航
  getSEOInfo: '/setting/seo' // seo信息
