  ...
  <div class="case-page case-page12">
    ...
    <div class="content wrapper">
      ...
      <section class="sec sec03">
        ...
        <p class="tar-desc">
          中山大学肿瘤医院信息科管理系统的建设目的是提供一套成熟的信息管理系统，网页端协同微信端，方便客户随时处理工作事务。系统主要建设目标如下：
        </p>
        <ul class="common-list">
          <li class="list-item">
            ...
            <p class="txt">
              故障管理，客户可以通过微信快速保障，同时在网页端批量处理故障。
            </p>
          </li>
          <li class="list-item">
            <span class="label">
            ...
            <p class="txt">
              知识库，可方便积累和查询参见故障，业务流程，培训文档等企业内部知识。
            </p>
          </li>
          <li class="list-item">
            <span class="label">
      ...
      <section class="sec sec04">
        ...
        <p class="sec04-txt">
          随着中山大学肿瘤医院信息科管理系统的建成并投入使用，中山大学附属肿瘤医院信息科摆脱了传统的管理方式，提高了工作效率。
        </p>
      </section>
    </div>
    <v-footer></v-footer>
