  ...
  <div class="case-page case-page07">
    ...
    <div class="content wrapper">
      ...
      <section class="sec sec01">
        ...
        <p class="common-desc">进入DT时代，传统经分系统架构已无法满足拓展数字化服务、数字经济转型以及大数据变现战略布局的需要。面对各类大数据项目需求，急需梳理、整合公司各类数据和渠道资源，做好底层规划，为大数据项目开展提供支撑服务。推动本地大数据项目的拓展,最终实现数据掘金，大数据变现的能力。同时考虑到需要使用更多内部系统和互联网的数据，结合同行经验，急需革新技术架构，引入分布式平台方案，为大数据的分析、报告、接口等提供支撑的能力。</p>
      </section>
      <!-- 客户需求 -->
      ...
      <section class="sec sec04">
        ...
        <p class="effect-desc">搭建大数据分析平台，提供可视化的统一管理界面。在大数据平台技术架构层面提供数据基础服务能力、系统平台管理能力、数据资产管理能力、应用共享开放能力和数据价值对外变现能力五个部分。</p>
