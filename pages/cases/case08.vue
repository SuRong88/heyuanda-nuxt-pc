  ...
  <div class="case-page case-page08">
    ...
    <div class="content wrapper">
      ...
      <section class="sec sec01">
        ...
        <p class="common-desc">
          我司为某省运营商电子渠道前端WEB应用提供了一套RAS动态应用防护系统， 以“动态令牌”、“动态封装”、“动态变幻”为技术核心，通过对服务器网页底层代码的持续动态变换，增加服务器行为的“不可预测性”；对企业内、外网的应用提供主动防护，有效防御传统攻击行为以及自动化攻击，以应对越来越严重的网络威胁。
        </p>
      </section>
      <!-- 客户需求 -->
      ...
      <section class="sec sec03">
        ...
        <ul class="common-list">
          <li class="list-item">
            ...
            <p class="txt">
              网站代码防护能力：采用URL动态封装技术，隐藏应用攻击入口，保护网站源码。
            </p>
          </li>
          <li class="list-item">
            <span class="label">
          ...
          <li class="list-item">
            ...
            <p class="txt">
              用户信息防护能力：采用客户端请求动态混淆技术，保护终端请求，过滤用户敏感信息。
            </p>
          </li>
          <li class="list-item">
            <span class="label">
            ...
            <p class="txt">
              业务逻辑防护能力：访问请求动态令牌技术，保障请求访问的唯一性，保障业务逻辑。
            </p>
          </li>
        </ul>
      </section>
