  ...
  <div class="case-page case-page11">
    ...
    <div class="content wrapper">
      ...
      <section class="sec sec01">
        ...
        <p class="common-desc">省排管系统是由广东省移动公司立项建设的一套全新排队管理解决方案，旨在对全省21个地市约1000间营业厅的排队机进行联网集中管理，并为客户提供全新的排队服务体验。</p>
      </section>
      <!-- 客户需求 -->
      <section class="sec sec02">
        <h3 class="common-tit">客户需求</h3>
        <p class="demand-desc desc-center">
          “目前广东移动各营业厅都有独立的排队机系统，无法统一调度和监控，主要存在以下问题：”
        </p>
